...
- **Love meter** that fills up to a "Perfect Match"
...
```
proposal-website/
├── index.html      # Page markup and all screens
├── style.css       # Styling and animations
├── script.js       # Interactivity and screen flow
...
1. Clone the repository:
   ```bash
   git clone https://github.com/LiviniRuwanya/proposal-website.git
   ```
...
- Edit the questions, letter text, and proposal lines directly in the markup and `script.js`.
